...
public record OculosDTO(
                ...
                @Pattern(regexp = "^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$", message = "Cor inválida.") String cor,
                ...
                @NotNull(message = "Quantidade cannot be null") @Min(value = 1, message = "Quantidade deve ser maior ou igual a um") Integer quantidade,

                MarcaResponseDTO marca,

                @NotNull(message = "O id do tipo do óculos não pode ser nulo.") Integer idTipoOculos,
